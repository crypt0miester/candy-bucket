    ...
    return (
        <div className="container mx-auto max-w-6xl  p-8 2xl:px-0">
            <div className={styles.container}>
                <div className="navbar mb-2 shadow-lg h-20 bg-[#334069] text-neutral-content rounded-box">
                    ...
                    <div className="flex-none">
                        <WalletHeader>
                            {wallet ? (
                                <WalletAmount className="bg-[#334069]">
                ...
                <div className="text-center pt-2">
                    ...
                    {wallet && candyMachinesFetched ? (
                        <div className="container rounded-box bg-[#334069] pb-4 mb-5 mx-auto">
                            <br />
                    ...
                    <div className="container rounded-box bg-[#334069] p-4 mx-auto divide-y ">
